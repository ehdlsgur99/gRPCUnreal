...
class HelloResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hello.HelloResponse) */ {
 public:
...
class HelloRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hello.HelloRequest) */ {
 public:
...
inline const std::string& HelloRequest::greeting() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:hello.HelloRequest.greeting)
  return _internal_greeting();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void HelloRequest::set_greeting(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.greeting_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:hello.HelloRequest.greeting)
}
inline std::string* HelloRequest::mutable_greeting() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_greeting();
  // @@protoc_insertion_point(field_mutable:hello.HelloRequest.greeting)
  return _s;
}
...
inline std::string* HelloRequest::release_greeting() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:hello.HelloRequest.greeting)
  return _impl_.greeting_.Release();
}
inline void HelloRequest::set_allocated_greeting(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ...
  // @@protoc_insertion_point(field_set_allocated:hello.HelloRequest.greeting)
}
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void HelloResponse::set_reply(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
...
inline std::string* HelloResponse::mutable_reply() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void HelloResponse::set_allocated_reply(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
